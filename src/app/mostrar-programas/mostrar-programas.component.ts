...
@Component({
  selector: 'app-mostrar-programas',
  templateUrl: './mostrar-programas.component.html',
  styleUrls: ['./mostrar-programas.component.css']
})
export class MostrarProgramasComponent implements OnInit {
  account: User = new User();
  userSub: Subscription;
  displayedColumns = ['No', 'codigo', 'nombre', 'plan de estudio', 'Fecha y Hora de inicio', 'Fecha y Hora de Fin', 'acciones'];
