...
@Component({
  selector: 'app-detalle-inscripcion-cancelada',
  templateUrl: './detalle-inscripcion-cancelada.component.html',
  styleUrls: ['./detalle-inscripcion-cancelada.component.css']
})
export class DetalleInscripcionCanceladaComponent implements OnInit {
  ...
  reabrirInscripcion() {
    if (confirm('Deseas abrir nuevamente la inscripcion del estudiante seleccionado?')) {
    }
  }
}
